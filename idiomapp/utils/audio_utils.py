...
def extract_translation_text(
    full_message: str, source_language: str, target_language: str
) -> str:
    """
    ...
    """
    logger.info(
        f"Extracting {target_language} translation from {source_language} source"
    )
...
def generate_audio(
    text: str, source_language: str = "unknown", target_language: str = None
) -> str:
    """
...
def process_translation_audio(
    ...
    try:
        ...
        translation_text = extract_translation_text(
            full_message, source_language, target_language
        )
